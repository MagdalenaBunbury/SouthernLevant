...
- Aoristic weighting was applied to site occupations and <sup>14</sup>C date distributions to account for potential biases, with a focus on the period **11,750–3,100 cal BP (9,800–1,150 BCE)** (**Fig. 3**).

![Aoristic weights](figures/figure3.png)

**Fig. 3** Aoristic weights of <sup>14</sup>C-dated sites and <sup>14</sup>C dates spanning 11,750–3,100 cal BP (9,800–1,150 BCE).
